        ...
        >
          ...
          <div className="relative aspect-[4/3] overflow-hidden">
            ...
            <Button
              size="icon"
              variant="ghost"
              className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm hover:bg-white shadow-sm"
              onClick={(e) => {
                e.preventDefault();
          ...
          {/* Hover Effect */}
          <div className="absolute inset-0 border-2 border-transparent group-hover:border-blue-300 rounded-xl transition-all duration-300 pointer-events-none"></div>
        </Link>
      ))}
    </div>
  );
